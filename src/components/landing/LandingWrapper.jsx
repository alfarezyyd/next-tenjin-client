    ...
    <main>
      ...
      <div className="relative z-50">
        ...
        <div style={{
          ...
          <div className="pr-4 h-[474px]" style={{
            minWidth: "100%", display: "table"
          }}>
          ...
          <div className="rounded-full bg-gray-100 border p-1"><svg stroke="none" fill="black" strokeWidth="1.5"
              ...
              <p className="leading-relaxed"><span className="block font-bold text-gray-700">AI </span>Hi, how can I
                help
                you today?
              </p>
            </div>
          ...
          <div className="rounded-full bg-gray-100 border p-1"><svg stroke="none" fill="black" strokeWidth="1.5"
              ...
              <p className="leading-relaxed"><span className="block font-bold text-gray-700">AI </span>Sorry, I
                couldnt
                find any
                information in the documentation about that. Expect answer to be less accurateI could not find the
                answer
                to
