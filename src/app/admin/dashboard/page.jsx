              ...
              <div className="card-stats">
                <div className="card-stats-title">Order Statistics -
                  <div className="dropdown d-inline">
                    <a className="font-weight-600 dropdown-toggle" data-toggle="dropdown" href="#"
                ...
                <div className="row">
                  <div className="col-sm-6">
                    ...
                    <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/id.svg"
                             alt="image" width="40"/>
                        <div className="media-body ml-3">
                          <div className="media-title">Indonesia</div>
                          <div className="text-small text-muted">3,282 <i className="fas fa-caret-down text-danger"></i>
                          </div>
                        </div>
                      </li>
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/my.svg"
                             alt="image" width="40"/>
                        <div className="media-body ml-3">
                          <div className="media-title">Malaysia</div>
                          <div className="text-small text-muted">2,976 <i className="fas fa-caret-down text-danger"></i>
                          </div>
                        </div>
                      </li>
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/us.svg"
                             alt="image" width="40"/>
                        <div className="media-body ml-3">
                          <div className="media-title">United States</div>
                          <div className="text-small text-muted">1,576 <i className="fas fa-caret-up text-success"></i>
                          </div>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="col-sm-6 mt-sm-0 mt-4">
                    ...
                    <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                      <li className="media">
                        ...
                        <div className="media-body ml-3">
                          <div className="media-title">Indonesia</div>
                          <div className="text-small text-muted">3,486 <i className="fas fa-caret-up text-success"></i>
                          </div>
                        </div>
                      </li>
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/ps.svg"
                             alt="image" width="40"/>
                        <div className="media-body ml-3">
                          <div className="media-title">Palestine</div>
                          <div className="text-small text-muted">3,182 <i className="fas fa-caret-up text-success"></i>
                          </div>
                        </div>
                      </li>
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/de.svg"
                             alt="image" width="40"/>
                        <div className="media-body ml-3">
                          <div className="media-title">Germany</div>
                          <div className="text-small text-muted">2,317 <i className="fas fa-caret-down text-danger"></i>
                          </div>
                        </div>
                      </li>
                    </ul>
            ...
            <div className="card">
              <div className="card-header">
                ...
                <div className="card-header-action">
                  <a href="#" className="btn btn-danger">View More <i className="fas fa-chevron-right"></i></a>
                </div>
              </div>
