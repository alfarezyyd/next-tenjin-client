...
import Nft1 from "../../../../public/assets/img/nfts/Nft1.png";
  ...
  return (
    <Card extra={"mt-3 !z-5 overflow-hidden"}>
      ...
      <div className="flex items-center justify-between rounded-t-3xl p-3">
        ...
        <button
          className="linear rounded-[20px] bg-lightPrimary px-4 py-2 text-base font-medium text-brand-500 transition duration-200 hover:bg-gray-100 active:bg-gray-200">
          See all
        </button>
      </div>
